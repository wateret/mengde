...
Path Path::operator/(const Path& rhs) const { return path_ / rhs.path_; }

Path Path::operator/(const string& rhs) const { return path_ / rhs; }

Path Path::operator/(const char* rhs) const { return path_ / rhs; }

...
class Serializer {
 ...
 private:
  ...
  flatbuffers::Offset<save::OCEECounterCounterAttack> Build(const OCEECounterCounterAttack& ocee);
  flatbuffers::Offset<save::OCEEReflectAttack> Build(const OCEEReflectAttack& ocee);

...
CallbackView::CallbackView() : CompositeView() { InitHandlers(); }

CallbackView::CallbackView(const Rect* rect) : CallbackView(*rect) {}

CallbackView::CallbackView(const Rect& rect) : CompositeView(rect) { InitHandlers(); }
...
void CallbackView::SetMouseButtonHandler(MouseButtonHandler handler) { mouse_button_handler_ = handler; }

void CallbackView::SetMouseMotionHandler(MouseMotionHandler handler) { mouse_motion_handler_ = handler; }
